...
function toggleDropdown() {
    document.querySelector(".board-create-dropdown-content").classList.toggle('board-create-dropdown-show');
}
...
window.onclick = function(event) {
    if (!event.target.matches('.board-create-dropdown-btn')) {
        let dropdowns = document.getElementsByClassName("board-create-dropdown-content");
...
function toggleDropdown2() {
    document.querySelector(".board-create-dropdown-content2").classList.toggle('board-create-dropdown-show');
}
...
window.onclick = function(event) {
    if (!event.target.matches('.board-create-dropdown-btn2')) {
        let dropdowns = document.getElementsByClassName("board-create-dropdown-content2");
        for (let i = 0; i < dropdowns.length; i++) {
            let openDropdown = dropdowns[i];
            if (openDropdown.classList.contains('board-create-dropdown-show')) {
                openDropdown.classList.remove('board-create-dropdown-show');
...
function toggleDropdown3() {
    document.querySelector(".board-create-dropdown-content3").classList.toggle('board-create-dropdown-show');
}
function selectLanguage(language) {
    ...
    // 중복 검사해야 됨
    document.getElementById("board-create-selected-languages").appendChild(languageBox);
    toggleDropdown3();
}
...
// 파일 선택 시 파일명 표시
document.getElementById("board-file-input").addEventListener('change', function() {
